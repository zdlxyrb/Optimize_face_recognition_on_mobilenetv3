...
def evaluate():
    ...
    checkpoint_path = './best_innovation_mobilenet_v3_large.pth'
    ...
    plt.savefig("../innovation_results/confusion_matrix.png")
    plt.show()
    ...
    plt.savefig("../innovation_results/f1_scores.png")
    plt.show()
    ...
    plt.legend()
    plt.savefig("../innovation_results/pr_curve.png")
    plt.show()
