...
def setup_logging(log_file="../logs/innovation_experiment_log.txt"):
    logging.basicConfig(
        level=logging.INFO,
...
def main():
    ...
    # 加载预训练权重（需确保权重文件存在）
    # model_weight_path = "../model/mobilenet_v3_large.pth"
    ...
    best_acc = 0.0
    save_path = './best_innovation_mobilenet_v3_large.pth'
    ...
    # 保存指标记录
    with open('./innovation_metrics.json', 'w') as f:
